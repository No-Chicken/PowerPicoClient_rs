...
export const zh = {
  ...
  settings: {
    ...
    checking: '正在检查…', downloadInstall: '下载并安装', downloadingUpdate: '正在下载更新…', installing: '正在安装…', updateCancelled: '更新已取消',
...
export const en = {
  ...
  settings: {
    ...
    checking: 'Checking…', downloadInstall: 'Download and install', downloadingUpdate: 'Downloading update…', installing: 'Installing…', updateCancelled: 'Update cancelled',
