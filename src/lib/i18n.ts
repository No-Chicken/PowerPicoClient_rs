...
export const zh = {
  ...
  settings: {
    ...
    checking: '正在检查…', updateUnavailable: '当前版本暂未提供在线更新清单，请稍后重试。', downloadInstall: '下载并安装', downloadingUpdate: '正在下载更新…', installing: '正在安装…', updateCancelled: '更新已取消',
    storage: '存储与卸载', cache: '缓存', appData: '应用数据', logs: '日志', systemData: '系统数据', total: '合计', application: '应用程序',
    clearCache: '清理缓存', cleaning: '正在清理…', cacheCleared: '缓存已清理', confirmClearCache: '确定清理 PowerPico Client 缓存吗？当前内部采集记录也会被清除。',
    uninstall: '卸载 PowerPico Client', uninstallHint: '删除应用和全部应用数据', confirmUninstall: '确定彻底卸载 PowerPico Client 吗？此操作会删除全部应用数据。', uninstalling: '正在卸载…', volumesToEject: '将推出的磁盘映像卷',
...
export const en = {
  ...
  settings: {
    ...
    checking: 'Checking…', updateUnavailable: 'The update manifest is not available for this version yet. Try again later.', downloadInstall: 'Download and install', downloadingUpdate: 'Downloading update…', installing: 'Installing…', updateCancelled: 'Update cancelled',
    storage: 'Storage and uninstall', cache: 'Cache', appData: 'Application data', logs: 'Logs', systemData: 'System data', total: 'Total', application: 'Application',
    clearCache: 'Clear cache', cleaning: 'Cleaning…', cacheCleared: 'Cache cleared', confirmClearCache: 'Clear the PowerPico Client cache? The current internal recording will also be removed.',
    uninstall: 'Uninstall PowerPico Client', uninstallHint: 'Remove the application and all its data', confirmUninstall: 'Completely uninstall PowerPico Client? All application data will be deleted.', uninstalling: 'Uninstalling…', volumesToEject: 'Disk image volumes to eject',
...
export const zhHk = {
  ...
  settings: {
    ...zh.settings, title: '設定', language: '介面語言', about: '關於開源版本', storage: '儲存空間與解除安裝',
    cache: '快取', appData: '應用程式資料', logs: '記錄', systemData: '系統資料', clearCache: '清除快取', cleaning: '正在清除…',
    cacheCleared: '快取已清除', confirmClearCache: '確定清除 PowerPico Client 快取嗎？目前的內部擷取記錄也會被移除。',
    uninstall: '解除安裝 PowerPico Client', uninstallHint: '移除應用程式及全部資料', confirmUninstall: '確定完整解除安裝 PowerPico Client 嗎？所有應用程式資料都會被刪除。', uninstalling: '正在解除安裝…', volumesToEject: '將退出的磁碟映像卷',
  },
...
export const ja = {
  ...
  settings: {
    ...en.settings, title: '設定', language: '表示言語', appearance: '外観', update: 'ソフトウェア更新', help: 'ヘルプ',
    storage: 'ストレージとアンインストール', cache: 'キャッシュ', appData: 'アプリデータ', logs: 'ログ', systemData: 'システムデータ',
    clearCache: 'キャッシュを消去', cleaning: '消去中…', cacheCleared: 'キャッシュを消去しました', confirmClearCache: 'PowerPico Client のキャッシュを消去しますか？現在の内部記録も削除されます。',
    uninstall: 'PowerPico Client をアンインストール', uninstallHint: 'アプリとすべてのデータを削除', confirmUninstall: 'PowerPico Client を完全にアンインストールしますか？すべてのアプリデータが削除されます。', uninstalling: 'アンインストール中…', volumesToEject: '取り出すディスクイメージボリューム',
  },
